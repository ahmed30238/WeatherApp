...
import 'package:weather_app/weather/data/repo/weather_repo.dart';
import 'package:weather_app/weather/domain/repo/weather_repo.dart';
import 'package:weather_app/weather/domain/usecases/get_weather_by_country_name.dart';
...
void main() async {
  ...
  var response =
      await GetWeatherWithCountryName(baseWeatherRepository).execute('egypt');
  print(response.main);
  print(response.name);
  print('object');
